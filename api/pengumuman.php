      ...
      <div class="banner_main">
         <div class="news w3-animate-bottom" style="padding: 30px 20px;">
            <div class="container">
               ...
               <div class="opening daftarp" id="about">
                  <div>
                     <a href="konten pengumuman 2.html">
                        <h2>Pengumuman 2</h2>
                        <h1>01-01-2023</h1>
                     </a>
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam pariatur, ullam unde earum, est sapiente odit iste dolore ratione quis consequatur. Repellat unde dolor vero ab. Eos earum qui deserunt!
               ...
               <div class="opening daftarp" id="about">
                  <div>
                     <a href="konten pengumuman 3.html">
                        <h2>Pengumuman 3</h2>
                        <h1>01-01-2023</h1>
                     </a>
               ...
               <div class="opening daftarp" id="about">
                  <div>
                     <a href="konten pengumuman 4.html">
                        <h2>Pengumuman 4</h2>
                        <h1>01-01-2023</h1>
                     </a>
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam pariatur, ullam unde earum, est sapiente odit iste dolore ratione quis consequatur. Repellat unde dolor vero ab. Eos earum qui deserunt!
               ...
               <div class="opening daftarp" id="about">
                  <div>
                     <a href="konten pengumuman 5.html">
                        <h2>Pengumuman 5</h2>
                        <h1>01-01-2023</h1>
                     </a>
                     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam pariatur, ullam unde earum, est sapiente odit iste dolore ratione quis consequatur. Repellat unde dolor vero ab. Eos earum qui deserunt!
               ...
               <nav aria-label="Page navigation example">
                  <ul class="pagination justify-content-end">
                     ...
                     <li class="page-item"><a class="page-link" href="pengumuman2.html">2</a></li>
                     <!-- <li class="page-item">
